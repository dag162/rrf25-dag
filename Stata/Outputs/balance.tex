...
%%% iebaltab hh_size n_child_5 n_elder read sick female_head livestock_now area_acre_w drought_flood crop_damage, grpvar(treatment) rowvarlabels format(%9.2f) savecsv("C:/Github/rrf25-dag/Stata/Outputs/balance.csv") savetex("C:/Github/rrf25-dag/Stata/Outputs/balance.tex") nonote addnote("Significance: ***=0.01, **=0.05, *=0.1") replace
...
\multicolumn{6}{@{} p{\textwidth}}{Significance: ***=0.01, **=0.05, *=0.1}
